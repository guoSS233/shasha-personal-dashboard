...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: ["/articles/2026-summer/venue.jpg"],
  },
  twitter: {
    ...
    <main className="essayPage">
      ...
      <article className="essay">
        ...
        <figure className="essayFigure essayHeroImage">
          <img src="/articles/2026-summer/venue.jpg" alt="上海 TI 场馆外墙投射着参赛战队标志" />
        ...
        <div className="essayBody">
          ...
          <figure className="essayFigure essayWide">
            <img src="/articles/2026-summer/arena.jpg" alt="坐满观众的 TI 比赛现场" />
          ...
          <figure className="essayFigure essayWide">
            <img src="/articles/2026-summer/reflections.jpg" alt="上海夜色中倒映在水面上的赛事灯光装置" />
          ...
          <figure className="essayFigure essaySummary">
            <img src="/articles/2026-summer/summary.png" alt="旧 PC 时代、电竞现场与 AI 技能树交汇的编辑插画" />
