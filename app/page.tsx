...
export default function Home() {
  ...
  return (
    <main>
      <nav className="topbar"><a className="brand" href="#top"><span>S</span> SHASHA / OS</a><div className="navlinks"><a href="#work">工作</a><a href="#projects">项目</a><a href="#articles">文章</a><a href="#thinking">思考</a><a href="#life">生活</a></div><div className="live"><i /> MEMORY ONLINE</div></nav>
      ...
      {(mode === "overview" || mode === "life") && <><section className="section articlesSection" id="articles"><header className="sectionHead"><div><small>03 / ARTICLES</small><h2>最近写下的东西</h2></div><p>把一次现场、一个问题和迟迟没有散去的感觉，写成可以回看的记录。</p></header><a className="articleCard" href="/articles/2026-summer/"><img src="/articles/2026-summer/venue-v2.jpg" alt="上海 TI 场馆外墙上的战队标志" /><div className="articleCardBody"><div className="articleMeta"><span>2026.08.23</span><span>DOTA 2 · 现场与时代</span></div><h3>2026年的夏天即将过去，我很怀念它。</h3><p>从上海 TI 的一个周末，想到东欧 Dota、逐渐成熟的玩家，以及一代人的技能树如何变化。</p><b>阅读全文 ↗</b></div></a></section>
        <section className="section thinking" id="thinking"><header className="sectionHead"><div><small>04 / SIGNALS</small><h2>最近在想什么</h2></div><p>记录那些反复出现、值得继续追踪的信号。</p></header><div className="signalGrid">{signals.map(([k,t,d])=><article key={t}><span>{k}</span><h3>{t}</h3><p>{d}</p></article>)}</div><div className="outputBox"><div><small>OUTPUT ENGINE / v0.1</small><h3>把一天变成可以复利的材料</h3></div><div className="flow"><span>全天采集</span><b>→</b><span>自动归档</span><b>→</b><span>晚间总结</span><b>→</b><span>观点 / 案例 / 选题</span></div></div></section>
        <section className="section life" id="life"><header className="sectionHead"><div><small>05 / OFFLINE</small><h2>工作以外，我也由这些组成</h2></div><p>这些兴趣也是我观察世界的一组传感器。</p></header><div className="interestCloud">{interests.map((v,i)=>v === "摇滚 / 电子 / 独立" ? <a className="interestLink" href={playlistUrl} target="_blank" rel="noreferrer" aria-label="打开我的网易云音乐歌单" key={v} style={{'--i':i} as React.CSSProperties}>{v}<sup>↗</sup></a> : <span key={v} style={{'--i':i} as React.CSSProperties}>{v}</span>)}</div><a className="musicEntry" href="/music/"><span>LIFE / MUSIC</span><strong>我的音乐</strong><em>歌单与最近在听 ↗</em></a><div className="principles"><article><b>01</b><h3>观察比结论更长久</h3><p>喜欢从城市动线、产品细节、人的措辞里找出背后的结构。</p></article><article><b>02</b><h3>关系不只由结果定义</h3><p>真诚地建立连接，同时学习接受边界、变化与无法控制的部分。</p></article><article><b>03</b><h3>乐观是一种行动</h3><p>相信世界螺旋上升，但不靠空想；先把眼前能做的事推一步。</p></article></div></section></>}
      <footer><div><span>SHASHA / PERSONAL OS</span><p>一份持续更新的自我索引。</p></div><a href="#top">BACK TO TOP ↑</a></footer>
    </main>
  );
}
